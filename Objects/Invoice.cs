...
namespace IIS.Shop
{
    ...
    [View("InvoiceE", new string[] {
            ...
            "Note as \'Примечание\'",
            "ShipmentDate as \'Дата и время отгрузки\'",
            "ResponsiblePerson as \'Товар выдал\'",
            "ResponsiblePerson.LastName as \'\'",
            "ResponsiblePerson.FirstName as \'\'",
            "ResponsiblePerson.MiddleName as \'\'"}, Hidden=new string[] {
            "Order.Number",
    ...
    public class Invoice : IIS.Shop.Document
    {
        ...
        /// ShipmentDate.
        /// </summary>
        // *** Start programmer edit section *** (Invoice.ShipmentDate CustomAttributes)

        // *** End programmer edit section *** (Invoice.ShipmentDate CustomAttributes)
        public virtual System.DateTime? ShipmentDate
        {
            get
            {
                // *** Start programmer edit section *** (Invoice.ShipmentDate Get start)

                // *** End programmer edit section *** (Invoice.ShipmentDate Get start)
                System.DateTime? result = this.fShipmentDate;
                // *** Start programmer edit section *** (Invoice.ShipmentDate Get end)

                // *** End programmer edit section *** (Invoice.ShipmentDate Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Invoice.ShipmentDate Set start)

                // *** End programmer edit section *** (Invoice.ShipmentDate Set start)
                this.fShipmentDate = value;
                // *** Start programmer edit section *** (Invoice.ShipmentDate Set end)

                // *** End programmer edit section *** (Invoice.ShipmentDate Set end)
            }
        }
