...
namespace IIS.Shop
{
    ...
    public class OrderBS : ICSSoft.STORMNET.Business.BusinessServer
    {
        ...
        private static void createInvoiceNew(IIS.Shop.Order UpdatedObject)
        {
            Order order = UpdatedObject;
            Invoice invoice = new Invoice();
            invoice.Order = order;
            invoice.Status = IIS.Shop.InvoiceStatus.New;
            invoice.TotalSum = order.TotalSum;
            invoice.CreateDate = order.CreateDate;
            invoice.ShipmentDate = order.ShipmentDate;
            invoice.ResponsiblePerson = order.Manager;
            DataServiceProvider.DataService.UpdateObject(invoice);
        ...
        public virtual ICSSoft.STORMNET.DataObject[] OnUpdateOrder(IIS.Shop.Order UpdatedObject)
        {
                ...
                && UpdatedObject.Status == OrderStatus.Paid)
            {
                ...
                createInvoiceNew(UpdatedObject);
                return result;
            }
